...
public class ModelMinepodsPro extends ModModelBaubleBase {
	public ModelMinepodsPro() {
		...
		cube_r1.setTextureOffset(123, 2).addBox(-4.1F, -28.25F, -8.5F, 1, 1, 1, false);
		cube_r1.setTextureOffset(120, 0).addBox(-4.2F, -28.5F, -7.5F, 1, 2, 1, false);
		cube_r1.setTextureOffset(124, 0).addBox(3.1F, -28.25F, -8.5F, 1, 1, 1, false);
		cube_r1.setTextureOffset(120, 3).addBox(3.2F, -28.5F, -7.5F, 1, 2, 1, false);
	}
}
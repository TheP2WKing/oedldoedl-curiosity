...
public class ItemBunnyCap extends ModItemBaubleBase {
	public ItemBunnyCap(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

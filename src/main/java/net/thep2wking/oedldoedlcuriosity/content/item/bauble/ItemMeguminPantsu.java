...
public class ItemMeguminPantsu extends ModItemBaubleBase {
	public ItemMeguminPantsu(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

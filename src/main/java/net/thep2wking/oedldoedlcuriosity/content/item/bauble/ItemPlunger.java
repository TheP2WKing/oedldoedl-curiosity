...
public class ItemPlunger extends ModItemBaubleBase {
	public ItemPlunger(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

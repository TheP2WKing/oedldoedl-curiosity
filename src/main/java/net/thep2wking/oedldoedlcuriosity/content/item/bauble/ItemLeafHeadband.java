...
public class ItemLeafHeadband extends ModItemBaubleBase {
	public ItemLeafHeadband(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

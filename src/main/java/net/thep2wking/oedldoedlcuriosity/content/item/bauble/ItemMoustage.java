...
public class ItemMoustage extends ModItemBaubleBase {
	public ItemMoustage(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

...
public class ItemMonocle extends ModItemBaubleBase {
	public ItemMonocle(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

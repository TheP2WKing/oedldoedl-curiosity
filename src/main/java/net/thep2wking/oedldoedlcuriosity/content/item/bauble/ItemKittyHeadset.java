...
public class ItemKittyHeadset extends ModItemBaubleBase {
	public ItemKittyHeadset(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

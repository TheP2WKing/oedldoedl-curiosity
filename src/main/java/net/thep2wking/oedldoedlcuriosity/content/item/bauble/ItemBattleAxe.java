...
import net.thep2wking.oedldoedlcuriosity.model.ModelBattleAxe;

public class ItemBattleAxe extends ModItemBaubleBase {
	public ItemBattleAxe(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

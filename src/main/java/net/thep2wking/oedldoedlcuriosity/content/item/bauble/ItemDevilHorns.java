...
public class ItemDevilHorns extends ModItemBaubleBase {
	public ItemDevilHorns(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public Multimap<IAttribute, AttributeModifier> getBaubleAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE, new AttributeModifier(ModReferences.ATTRIBUTE_ATTACK_DAMAGE,
				0.1, AttributeModifierOperation.ADD_MULTIPLE));
		return multimap;
	}
}
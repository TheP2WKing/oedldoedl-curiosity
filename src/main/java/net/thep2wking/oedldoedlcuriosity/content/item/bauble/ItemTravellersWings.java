...
public class ItemTravellersWings extends ModItemBaubleEffectBase {
	public ItemTravellersWings(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (player.fallDistance > 6 && !player.isSneaking()) {
			player.addPotionEffect(new PotionEffect(ModPotions.SLOW_FALLING, 19, 0, false, false));
		}
		player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST,
				CuriosityConfig.PROPERTIES.EFFECTS.BAUBLE_BASE_DURATION, 3, false, false));
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (ModTooltips.showEffectTip()) {
			...
			ModTooltips.addPotionEffect(tooltip, MobEffects.JUMP_BOOST.getName(), false, 4,

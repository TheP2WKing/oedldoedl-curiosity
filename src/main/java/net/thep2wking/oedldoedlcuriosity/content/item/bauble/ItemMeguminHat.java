...
public class ItemMeguminHat extends ModItemBaubleEffectBase {
	public ItemMeguminHat(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

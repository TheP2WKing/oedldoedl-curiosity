...
public class ItemCrown extends ModItemBaubleBase {
	public ItemCrown(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public Multimap<IAttribute, AttributeModifier> getBaubleAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.LUCK,
				new AttributeModifier(ModReferences.ATTRIBUTE_LUCK, 10, AttributeModifierOperation.ADD_MULTIPLE));
		return multimap;
	}
}
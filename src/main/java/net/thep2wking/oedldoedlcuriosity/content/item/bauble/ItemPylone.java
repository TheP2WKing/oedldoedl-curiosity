...
public class ItemPylone extends ModItemBaubleBase {
	public ItemPylone(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

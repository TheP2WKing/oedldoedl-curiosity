...
public class ItemDevilWings extends ModItemBaubleBase {
	public ItemDevilWings(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

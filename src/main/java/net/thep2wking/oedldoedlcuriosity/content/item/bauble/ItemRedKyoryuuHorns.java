...
public class ItemRedKyoryuuHorns extends ModItemBaubleBase {
	public ItemRedKyoryuuHorns(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public ModelBiped getBaubleModel() {
		return new ModelRedKyoryuuHorns();
	}
}
...
public class ItemDevilTail extends ModItemBaubleBase {
	public ItemDevilTail(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

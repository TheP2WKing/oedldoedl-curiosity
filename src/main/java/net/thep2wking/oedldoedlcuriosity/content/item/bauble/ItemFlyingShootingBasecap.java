...
public class ItemFlyingShootingBasecap extends ModItemBaubleBase {
	public ItemFlyingShootingBasecap(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

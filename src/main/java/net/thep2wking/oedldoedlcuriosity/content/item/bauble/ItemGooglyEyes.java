...
public class ItemGooglyEyes extends ModItemBaubleBase {
	public ItemGooglyEyes(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

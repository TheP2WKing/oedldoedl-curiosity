...
public class ItemBlueKyoryuuHorns extends ModItemBaubleBase {
	public ItemBlueKyoryuuHorns(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public ModelBiped getBaubleModel() {
		return new ModelBlueKyoryuuHorns();
	}
}
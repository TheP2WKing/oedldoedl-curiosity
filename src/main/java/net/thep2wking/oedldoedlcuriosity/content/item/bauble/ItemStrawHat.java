...
public class ItemStrawHat extends ModItemBaubleBase {
	public ItemStrawHat(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

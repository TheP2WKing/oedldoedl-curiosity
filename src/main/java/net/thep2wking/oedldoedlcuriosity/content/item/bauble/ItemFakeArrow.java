...
public class ItemFakeArrow extends ModItemBaubleBase {
	public ItemFakeArrow(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

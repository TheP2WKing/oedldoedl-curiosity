...
import net.thep2wking.oedldoedlcuriosity.model.ModelTopHat;

public class ItemTopHat extends ModItemBaubleBase {
	public ItemTopHat(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

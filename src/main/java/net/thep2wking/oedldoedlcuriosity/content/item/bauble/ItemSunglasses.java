...
public class ItemSunglasses extends ModItemBaubleBase {
	public ItemSunglasses(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,

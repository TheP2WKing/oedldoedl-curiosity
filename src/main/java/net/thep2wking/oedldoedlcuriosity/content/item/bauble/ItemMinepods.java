...
public class ItemMinepods extends ModItemBaubleBase {
	public ItemMinepods(String modid, String name, CreativeTabs tab, SoundEvent sound, BaubleType baubleType,
	...
	public Multimap<IAttribute, AttributeModifier> getBaubleAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED, new AttributeModifier(
				ModReferences.ATTRIBUTE_MOVEMENT_SPEED, 0.15, AttributeModifierOperation.ADD_MULTIPLE));
		return multimap;
	}
}